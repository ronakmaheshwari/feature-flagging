...
import { addNewRouterController, changeRouterFlagController, deleteRouterFlagController, getAllRouterController } from "../controller/routeFlagController";

const routerFlagRouter: Router = Router();

routerFlagRouter.get("/", userMiddleware, getAllRouterController);
